...
public class App {
    public static void main(String[] args) throws IOException, CloneNotSupportedException {
        ...
        performData.setType("dfsd");
        performData.setContext("cdsf");
        performData.setMetaId("meta");

        PerformData clone = performData.clone();
        clone.setType("chen");

        List<PerformData> performData1 = Arrays.asList(performData, clone);


        performDataDao.bat(performData1);
    }
}
